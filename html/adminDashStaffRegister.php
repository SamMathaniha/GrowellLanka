...
if(isset($_POST['submit'])){
   ...
   $JoinedDate = mysqli_real_escape_string($conn,$_POST['JoinedDate']);
   $LeftDate = mysqli_real_escape_string($conn,$_POST['LeftDate']);


   
   $select = " SELECT * FROM staff WHERE name = '$name' && email = '$email' ";
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      $error[] = 'user already exist!';
         ...
         $insert = "INSERT INTO staff(name,email,DOB,Department,Team_No,PhoneNo1,PhoneNo2,Gender,JoinedDate,LeftDate) VALUES('$name','$email','$DOB','$Department','$Team_No','$PhoneNo1','$PhoneNo2','$Gender','$JoinedDate','$LeftDate')";
...
<body >
  ...
  <div class="form-container">
    <label class="form-label" for="Team_No">Team No:</label>
    <div class="form-input">
      <input type="text" id="Team_No" name="Team_No"><br>
    </div>
  </div>
  ...
  <div class="form-container">
    <label class="form-label" for="DOB">Left Date:</label>
    <div class="form-input">
      <input type="date" id="LeftDate" name="LeftDate"><br>
    </div>
  </div>
  ...
  <div class="form-container">
    ...
    <div class="form-input">
      <button class="button" type="submit" name="submit">Register New Staff</button>
