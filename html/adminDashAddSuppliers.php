...
if(isset($_POST['submit'])){
   ...
   $select = " SELECT * FROM suppliers WHERE name = '$name' && email = '$email' ";
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      $error[] = 'user already exist!';
         ...
         $insert = "INSERT INTO suppliers(name,email,product,PhoneNo1,PhoneNo2) VALUES('$name','$email','$product','$PhoneNo1','$PhoneNo2')";
...
<?php
  ...
  ?>
<h3>New Suppliers Registration</h3>
